<x-layouts.master>
                ...
                <form action="{{ route('storeSession') }}" method="POST">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3 flex items-end">
                            <x-button type="submit" label="Login">Generate</x-button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="p-4 mb-4 m-4 xl:gap-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody id="tableBody">
                    ...
                    <tr class="border-b dark:border-gray-700">
                        <th scope="row"
                            class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white product">{{ $data['product'] }}</th>
                        <th scope="row"
                            class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white batch">{{ $data['batch'] }}</th>
                        ...
                        <td class="px-4 py-3 flex items-center justify-end">
                            ...
                            <div id="{{ $data['uuid'] }}-dropdown"
                                ...
                                <ul class="py-1 text-sm"
                                    aria-labelledby="{{ $data['uuid'] }}-dropdown-button">
                                    <li>
    ...
    <!-- Update modal -->
    <x-modal-form id="updateSession" data-modal-toggle="updateSession" action="{{ route('updateSession') }}"
        ...
        <div>
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Storage Bin</label>
                          <div class="relative" onclick="event.stopImmediatePropagation();">
                              ...
                              />
                              <div
                                  id="e_dropdownStorageBin"
                                  class="w-full h-60 border border-gray-300 rounded-md bg-white absolute overflow-y-auto hidden"
                              ></div>
                          </div>
        </div>
        <div class="sm:col-span-2">
            <x-text-input for="qty" id="e_qty" type="number" name="e_qty" label="Qty" placeholder="Type qty here.."/>
        </div>
        <div class="sm:col-span-2 hidden">
            <x-text-input for="uuid" id="e_uuid" type="text" name="e_uuid" label="uuid" placeholder="Type uuid here.."/>
        </div>
    ...
    <x-slot name="js">
        <script>
            ...
            document.addEventListener("click", () => {
                ...
                hideDropdown("e_dropdownProduct");
                hideDropdown("e_dropdownSloc");
