                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row"
                                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">R0000032</th>
                                    <td class="px-4 py-3 max-w-[12rem] truncate ">Full Cream Milk</td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate ">240814-A1</td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate ">1200 Kg</td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate ">RM 94</td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate ">MH0101</td>
                                </tr>
                        </tbody>
                    </table>
                </div>
