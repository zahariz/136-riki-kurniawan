<x-layouts.master>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form action="{{ route('product') }}" method="GET" class="flex items-center" id="search-form">
                            ...
                            <div class="relative flex items-center justify-between">
                                ...
                                <a href="{{ route('product') }}" type="button" id="reset-button" class="text-gray-600 hover:text-gray-700 dark:text-white underline text-sm ml-2 hidden">Reset</a>
                    ...
                    <div
                        ...
                        <x-button type="button" id="createProductModalButton" data-modal-target="createProductModal"
                            data-modal-toggle="createProductModal" class="flex items-center">
    ...
    <x-modal-form id="createProductModal" data-modal-hide="createProductModal" method="POST" action="{{ route('product.store') }}"
     ...
     @csrf
        ...
        <div>
            <x-text-input for="sku" type="text" name="sku" id="category" label="Sku"
    ...
    <x-modal-form id="updateProductModal" data-modal-hide="updateProductModal" action=""
     title-modal="Update Product">
        ...
        <div>
            <x-text-input for="sku" type="text" name="sku" id="e_sku" label="Sku"
                placeholder="Ex. R000032" />
        </div>
        <div class="sm:col-span-2">
